...
public class MyFormAuthenticationFilter extends AuthenticatingFilter {
	...
	private String loginTypeValue=null;
	private String failureKeyAttribute = DEFAULT_ERROR_KEY_ATTRIBUTE_NAME;
	private String mySuccessUrl="/";
	
	
	public String getMySuccessUrl() {
		return mySuccessUrl;
	}

	public void setMySuccessUrl(String mySuccessUrl) {
		this.mySuccessUrl = mySuccessUrl;
	}
	...
	protected AuthenticationToken createToken(String username, String password,
		...
		setLoginTypeValue(request.getParameter(getLoginTypeParam()));
		request.getServletContext().setAttribute(username+"userType", getLoginTypeValue());
		return createToken(username, password, rememberMe, host);
	}

	protected AuthenticationToken createToken(String username, String password,
			boolean rememberMe, String host) {
		return new UsernamePasswordByUserTypeToken(username, password.toCharArray(), rememberMe, host,getLoginTypeValue());
	}
